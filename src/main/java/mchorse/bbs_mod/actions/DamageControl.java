...
public class DamageControl
{
    ...
    public void addBlock(BlockPos pos, BlockState state, BlockEntity entity)
    {
        ...
        RegistryWrapper.WrapperLookup registryLookup = this.world.getRegistryManager();
        this.blocks.add(new BlockCapture(new BlockPos(pos), state, entity == null ? null : entity.createNbtWithIdentifyingData(registryLookup)));
    }
    ...
    public void restore()
    {
        ...
        for (BlockCapture block : this.blocks)
        {
            ...
            {
                BlockEntity blockEntity = BlockEntity.createFromNbt(block.pos, block.lastState, block.blockEntity, registryLookup);
