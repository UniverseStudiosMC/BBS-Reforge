...
public abstract class Form extends ValueGroup
{
    ...
    public void onMorph(LivingEntity entity)
    {
        ...
        if (stepHeight != 0.6F) entity.getAttributeInstance(EntityAttributes.GENERIC_STEP_HEIGHT).setBaseValue(stepHeight);
    }
    ...
    public void onDemorph(LivingEntity entity)
    {
        ...
        entity.getAttributeInstance(EntityAttributes.GENERIC_STEP_HEIGHT).setBaseValue(0.6F);
    }
