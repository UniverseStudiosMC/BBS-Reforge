...
public class UIItemStackOverlayPanel extends UIOverlayPanel
{
    ...
    public UIItemStackOverlayPanel(Consumer<ItemStack> callback, ItemStack stack)
    {
        ...
        {
            // In 1.21.1, setCustomName() was removed - use Data Components API
        ...
        this.nbt = new UITextarea<>((v) ->
        {
            try
            {
                ...
                // In 1.21.1, use CODEC.parse() instead of fromNbtOrEmpty()
                ItemStack itemStack = ItemStack.CODEC.parse(NbtOps.INSTANCE, nbtCompound)
                    .result()
    ...
    {
        this.stack = new ItemStack(Registries.ITEM.get(Identifier.tryParse(s)));
