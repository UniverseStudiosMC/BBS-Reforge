...
public class UIParticleSchemeRenderer extends UIModelRenderer
{
    ...
    protected void renderUserModel(UIContext context)
    {
        ...
        stack.push();
        stack.loadIdentity();
        // In 1.21.1, derive inverse view rotation from our camera's view matrix
        Matrix4f inverseViewRotation = mchorse.bbs_mod.utils.MatrixStackUtils.getInverseViewRotationMatrix(this.camera);
        stack.multiplyPositionMatrix(new Matrix4f(inverseViewRotation).invert());
