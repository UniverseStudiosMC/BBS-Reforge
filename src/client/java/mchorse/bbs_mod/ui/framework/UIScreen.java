...
public class UIScreen extends Screen implements IFileDropListener
{
    ...
    public void onDisplayed()
    {
        ...
        mc.options.getGuiScale().setValue(BBSModClient.getGUIScale());

        // In 1.21.1, this.client may be null when onDisplayed is called from setScreen
        // Only call super and resolution change if client is initialized
        if (this.client != null)
        {
            super.onDisplayed();
    ...
    {
        // In 1.21.1, resize can be called before client is fully set
        // Also check this.client to ensure Screen is fully initialized
