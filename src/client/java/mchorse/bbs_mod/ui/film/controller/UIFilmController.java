...
public class UIFilmController extends UIElement
{
    ...
    private void renderPickingPreview(UIContext context, Area area)
    {
        ...
        // RenderSystem.setInverseViewRotationMatrix removed in 1.21.1 - shader system handles this differently now
        ...
        if (altPressed)
        {
            for (Map.Entry<Integer, IEntity> entry : this.getEntities().entrySet())
            {
                ...
                BaseFilmController.renderEntity(FilmControllerContext.instance
                    ...
                    .transition(isPlaying ? MinecraftClient.getInstance().getRenderTickCounter().getTickDelta(true) : 0)
