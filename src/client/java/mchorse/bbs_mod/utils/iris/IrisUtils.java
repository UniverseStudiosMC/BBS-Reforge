...
public class IrisUtils
{
    ...
    /**
     * Setup method - PBR texture loading disabled in 1.21.1 due to API changes.
     * TextureTracker and PBRTextureLoaderRegistry are no longer available.
     */
    public static void setup()
    {
        // PBRTextureLoaderRegistry.INSTANCE.register(IrisTextureWrapper.class, new IrisTextureWrapperLoader());
        // Disabled - internal Iris texture API changed in 1.8.0
    }

    /**
     * Track texture - disabled in 1.21.1 due to TextureTracker API removal.
     */
    public static void trackTexture(Texture texture)
    {
        // TextureTracker.INSTANCE.trackTexture() no longer available
        // Disabled - internal Iris texture API changed in 1.8.0
    }
