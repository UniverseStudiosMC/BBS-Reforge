...
public class VideoRecorder
{
    ...
    private long frameRemainderNanos;
    ...
    public void startRecording(File audioFile, int textureId, int width, int height)
    {
        ...
        this.targetFrameNanos = (long) (1_000_000_000D / BBSRendering.getVideoFrameRate());
        this.frameRemainderNanos = this.targetFrameNanos; /* emit first frame immediately */
    ...
    public void recordFrame()
    {
        ...
        {
            this.frameRemainderNanos += now - this.lastFrameTimeNanos;
            this.lastFrameTimeNanos = now;
        }

        int framesToWrite = (int) (this.frameRemainderNanos / this.targetFrameNanos);
        this.frameRemainderNanos = this.frameRemainderNanos % this.targetFrameNanos;
        ...
        try
        {
            ...
            if (mappedBuffer != null && framesToWrite > 0 && this.counter != 0)
            {
