...
public class MinecraftSourcePack implements ISourcePack
{
    ...
    {
        return this.manager.getResource(Identifier.tryParse(link.toString())).isPresent();
    }

    @Override
    public InputStream getAsset(Link link) throws IOException
    {
        Optional<Resource> resource = this.manager.getResource(Identifier.tryParse(link.toString()));
