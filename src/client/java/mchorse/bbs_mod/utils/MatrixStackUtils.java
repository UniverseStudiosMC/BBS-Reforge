...
public class MatrixStackUtils
{
    ...
    public static Matrix4f getInverseViewRotationMatrix(Camera camera)
    {
        Quaternionf rotation = camera.getRotation();
        return new Matrix4f().rotation(new Quaternionf(rotation).conjugate());
    }

    public static Matrix4f getInverseViewRotationMatrix(mchorse.bbs_mod.camera.Camera camera)
    {
        return new Matrix4f(camera.view).invert();
    }
