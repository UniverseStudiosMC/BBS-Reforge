...
public class ModelBlockItemRenderer implements BuiltinItemRendererRegistry.DynamicItemRenderer
{
    ...
    public Item get(ItemStack stack)
    {
        ...
        // In 1.21.1, apply block entity data using NbtComponent.applyToBlockEntity
        blockEntityData.applyToBlockEntity(entity, net.minecraft.client.MinecraftClient.getInstance().world.getRegistryManager());
