...
public class BBSRendering
{
    ...
    public static void onWorldRenderBegin()
    {
        ...
        // Begin dynamic lighting frame
        DynamicLightManager.getInstance().beginFrame();
    ...
    public static void onWorldRenderEnd()
    {
        ...
        // End dynamic lighting frame - remove stale light blocks
        DynamicLightManager.getInstance().endFrame();
    }
    ...
    public static void onRenderChunkLayer(MatrixStack stack)
    {
        ...
        // In 1.21.1, prepare() signature changed - no longer takes MatrixStack
        // New signature: prepare(WorldRenderer, RenderTickCounter, boolean, Camera, GameRenderer,
        //                        LightmapTextureManager, Matrix4f, Matrix4f, VertexConsumerProvider, Profiler, boolean, ClientWorld)
